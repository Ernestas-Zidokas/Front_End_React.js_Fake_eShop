...
function reducer(state = INITIAL_STATE, { type, payload }) {
  switch (type) {
    case actionTypes.GET_PRODUCTS:
      return { ...state, products: { ...INITIAL_PRODUCTS_STATE, loading: true } };

    case actionTypes.GET_PRODUCTS_SUCCESS:
      return { ...state, products: { ...INITIAL_PRODUCTS_STATE, data: payload } };

    case actionTypes.GET_PRODUCTS_FAILURE:
      return { ...state, products: { ...INITIAL_PRODUCTS_STATE, error: payload } };
    ...
    case actionTypes.TOGGLE_FAVORITE:
      return { ...state, favorites: toggleArrayItem(state.favorites, payload) };
